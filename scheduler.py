...
class Course:
    ...
    def __init__(self, class_string):
        ...
        self.finalExam_date = datetime.date(int(self.finalExam_date[2]), 
                                            int(self.finalExam_date[0]), 
                                            int(self.finalExam_date[1]))
    ...
    def getEventJSON(self, meeting_number):
        ...
        #JSON doesn't like colons and brackets...
        recurrence_string = re.sub('[:-]', '', recurrence_string) 

        #addition allows the first date of a Tuesday class to be set 
        #as one day after the first day
        addition = 0
    ...
    def getFinalJSON(self):
        ...
        event = {
            ...
            'start': {
                'dateTime': datetime.datetime.combine(self.finalExam_date, 
                                                      self.finalExam_time).isoformat(),
                'timeZone': 'America/Los_Angeles',
            },
            'end': {
                'dateTime': (datetime.datetime.combine(self.finalExam_date, 
