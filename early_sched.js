...
var Course = function(class_string){
	...
	var schedule_pattern = /^[A-Z]+.*[A|P]M .*/gm;
	var alt_schedulePattern = /^[A-Z][a-zA-Z\/ ]+[\r\n]+[0-9]{1,2}:[0-9]{2} [A|P]M - [0-9]{1,2}:[0-9]{2} [A|P]M[\r\n]+[A-Z]+[\r\n]+.*$/gm;
	...
	this.schedule_array = class_string.match(alt_schedulePattern);
	this.meeting_array = [];
